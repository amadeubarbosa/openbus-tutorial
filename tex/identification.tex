...
Devido a isso, observar o login de determinados sistemas pode ser muito útil na gerênicia dos recursos alocados pelo sistema.
...
Do lado dos clientes, basta que se realoque os recursos (\ie\ recriar as matrizes) sempre que precisar relogar.
