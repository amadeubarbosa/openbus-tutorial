...
Internamente um barramento \openbus{} é formado por uma arquitetura orientada a serviços (SOA - Service Oriented Architecture), conforme ilustrado na figura~\ref{fig:bussoa}.
