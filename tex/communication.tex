...
Ao invés disso apresentaremos um modelos mais simples e usuam em que os objetos são criados e descartados explicitamente pela aplicação.
...
Como resultado o compilador de IDL gerará código fonte Java que implementam definições em Java equivalentes as definições em IDL.
