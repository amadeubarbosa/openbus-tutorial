...
Adicionalmente, ofertaremos esse serviço com a operação adicional \code{domain} com o valor \code{"Tutorial"}, como ilustrado na figura~\ref{fig:ex16:matrices/Server:134:168}.
...
\inputexrange{ex16}{matrices/Server}{134}{168}{Registro de oferta do serviço de matrizes.}
