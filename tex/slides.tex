...
\begin{frame}
  ...
  \inputjava[firstline=61,lastline=73]{new}{ex07}{matrices/Server}
  \inputjava[firstline=74,lastline=80]{old}{ex07}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=186,lastline=201]{old}{ex13}{matrices/Server}
  \inputjava[firstline=202,lastline=202]{new}{ex13}{matrices/Server}
  \inputjava[firstline=203,lastline=208]{old}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Observador que Descarta Matrizes}
  \inputjava[firstline=68,lastline=70]{old}{ex13}{matrices/Server}
  \inputjava[firstline=71,lastline=72]{new}{ex13}{matrices/Server}
  \inputjava[firstline=73,lastline=74]{old}{ex13}{matrices/Server}
  \inputjava[firstline=75,lastline=76]{new}{ex13}{matrices/Server}
  \inputjava[firstline=77,lastline=78]{old}{ex13}{matrices/Server}
  \inputjava[firstline=79,lastline=92]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Criando Matriz que Notifica Descarte}
  \inputjava[firstline= 94,lastline=105]{old}{ex13}{matrices/Server}
  \inputjava[firstline=106,lastline=109]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Registrando Matriz para Descarte}
  \inputjava[firstline=111,lastline=111]{new}{ex13}{matrices/Server}
  \inputjava[firstline=112,lastline=112]{old}{ex13}{matrices/Server}
  \inputjava[firstline=113,lastline=128]{new}{ex13}{matrices/Server}
  \inputjava[firstline=129,lastline=131]{old}{ex13}{matrices/Server}
  \inputjava[firstline=132,lastline=132]{new}{ex13}{matrices/Server}
  \inputjava[firstline=133,lastline=134]{old}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Registrando Interesse no Login do Solicitante}
  \inputjava[firstline=127,lastline=128]{new}{ex13}{matrices/Server}
  \inputjava[firstline=129,lastline=131]{old}{ex13}{matrices/Server}
  \inputjava[firstline=132,lastline=132]{new}{ex13}{matrices/Server}
  \inputjava[firstline=133,lastline=135]{old}{ex13}{matrices/Server}
  \inputjava[firstline=136,lastline=151]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Descarte da Matriz}
  \inputjava[firstline=153,lastline=173]{new}{ex13}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=65,lastline=66]{old}{ex13}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=101,lastline=113]{old}{ex14}{matrices/Server}
  \inputjava[firstline=114,lastline=120]{new}{ex14}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 14: Inspecionando Ofertas Encontradas}
  \inputjava[firstline=122,lastline=134]{new}{ex14}{matrices/Server}
  \inputjava[firstline=135,lastline=141]{old}{ex14}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=138,lastline=155]{old}{ex15}{matrices/Server}
  \inputjava[firstline=156,lastline=156]{new}{ex15}{matrices/Server}
  \inputjava[firstline=157,lastline=165]{old}{ex15}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=106,lastline=114]{old}{ex15}{matrices/Server}
  \inputjava[firstline=115,lastline=115]{new}{ex15}{matrices/Server}
  \inputjava[firstline=116,lastline=118]{old}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Acesso Protegido ao Serviço}
  \inputjava[firstline=67,lastline=79]{new}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Buscando Novo Serviço Ofertado}
  \inputjava[firstline=81,lastline=94]{new}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Realizando Última Tentativa}
  \inputjava[firstline=96,lastline=104]{new}{ex15}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=143,lastline=150]{old}{ex16}{matrices/Server}
  \inputjava[firstline=151,lastline=157]{new}{ex16}{matrices/Server}
  \inputjava[firstline=158,lastline=158]{old}{ex16}{matrices/Server}
  \inputjava[firstline=159,lastline=161]{new}{ex16}{matrices/Server}
  \inputjava[firstline=162,lastline=165]{old}{ex16}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=146,lastline=148]{old}{ex20}{matrices/Server}
  \inputjava[firstline=149,lastline=168]{new}{ex20}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=140,lastline=143]{old}{ex21}{matrices/Server}
  \inputjava[firstline=144,lastline=150]{new}{ex21}{matrices/Server}
  \inputjava[firstline=151,lastline=163]{old}{ex21}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 21: Utilizando o Assistente (Servidor)}
  \inputjava[firstline=155,lastline=164]{old}{ex21}{matrices/Server}
  \inputjava[firstline=165,lastline=165]{new}{ex21}{matrices/Server}
  \inputjava[firstline=166,lastline=166]{old}{ex21}{matrices/Server}
  \inputjava[firstline=167,lastline=167]{new}{ex21}{matrices/Server}
  \inputjava[firstline=168,lastline=171]{old}{ex21}{matrices/Server}
  \inputjava[firstline=172,lastline=175]{new}{ex21}{matrices/Server}
  \inputjava[firstline=176,lastline=177]{old}{ex21}{matrices/Server}
\end{frame}
