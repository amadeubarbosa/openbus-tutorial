...
\newcommand{\exlabel}[1]{} % ignore this command, it is used in 'book.tex'
\newcommand{\inputlua}[4][]
  {\lstinputlisting[
    language=lua,escapechar=\$,style=#2,#1]{src/#3/lua/openbus/demo/#4.lua}}
\newcommand{\inputidl}[4][]
  {\lstinputlisting[
    language={[CORBA]IDL},escapechar=\$,style=#2,#1]{src/#3/idl/#4.idl}}
\newcommand{\inputjava}[4][]
  {\lstinputlisting[
    language=java,escapechar=\$,style=#2,#1]{src/#3/java/tecgraf/openbus/demo/#4.java}}
...
\addtobeamertemplate{frametitle}{
  \begin{textblock*}{\paperwidth}(-10pt,0pt)
    \includegraphics[width=.9\paperwidth,height=1cm]{img/tecgraf}
  \end{textblock*}
}
...
\frame{
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item Implementados sobre o sistema operacional.
...
\begin{frame}
  \frametitle{Estrutura do Código Gerado}
  \includegraphics[width=\textwidth]{img/idluml}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=17,lastline=26]{new}{ex06}{matrices/Application}
  \inputjava[firstline=27,lastline=38]{old}{ex06}{matrices/Application}
\end{frame}
...
RSAPrivateKey privateKey =
  Cryptography.getInstance().readKeyFromFile(fileName);
...
\begin{frame}
  ...
  \inputjava[firstline=62,lastline=62]{old}{ex07}{matrices/Server}
  \inputjava[firstline=63,lastline=75]{new}{ex07}{matrices/Server}
  \inputjava[firstline=76,lastline=82]{old}{ex07}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 07-B: Logout ao Final}
  \inputjava[firstline=76,lastline=85]{old}{ex07}{matrices/Server}
  \inputjava[firstline=86,lastline=86]{new}{ex07}{matrices/Server}
  \inputjava[firstline=87,lastline=89]{old}{ex07}{matrices/Server}
\end{frame}
...
public interface Connection {
  ...
  void loginBySharedAuth(SharedAuthSecret secret) throws
  ...
  ...
    ...
    \end{samplecode}
    \item Métodos para serialização do segredo:
    \begin{samplecode}
public interface OpenBusContext {
...
String b64text = DatatypeConverter.printBase64Binary(encoded);
...
byte[] encodedTest = DatatypeConverter.parseBase64Binary(b64text);
SharedAuthSecret secret = context.decodeSharedAuth(encodedTest);
      \end{samplecode}
    \end{itemize}
...
\begin{frame}
  ...
  \inputjava[firstline=21,lastline=28]{old}{ex08}{matrices/Application}
  \inputjava[firstline=29,lastline=32]{new}{ex08}{matrices/Application}
  \inputjava[firstline=33,lastline=39]{old}{ex08}{matrices/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 08: Compartilhando Autenticação}
  \inputjava[firstline=15,lastline=37]{new}{ex08}{showlogins/Application}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=56,lastline=57]{old}{ex09}{matrices/Server}
  \inputjava[firstline=58,lastline=67]{new}{ex09}{matrices/Server}
  \inputjava[firstline=68,lastline=78]{old}{ex09}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 09: Operação de Autorização da Matriz}
  \inputjava[firstline=20,lastline=24]{old}{ex09}{matrices/Server}
  \inputjava[firstline=25,lastline=36]{new}{ex09}{matrices/Server}
  \inputjava[firstline=37,lastline=38]{old}{ex09}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 09: Autorizando Chamadas da Matriz}
  \inputjava[firstline=40,lastline=40]{old}{ex09}{matrices/Server}
  \inputjava[firstline=41,lastline=41]{new}{ex09}{matrices/Server}
  \inputjava[firstline=42,lastline=47]{old}{ex09}{matrices/Server}
  \inputjava[firstline=48,lastline=48]{new}{ex09}{matrices/Server}
  \inputjava[firstline=49,lastline=53]{old}{ex09}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=104,lastline=114]{old}{ex11}{matrices/Server}
  \inputjava[firstline=115,lastline=117]{new}{ex11}{matrices/Server}
  \inputjava[firstline=118,lastline=119]{old}{ex11}{matrices/Server}
  \inputjava[firstline=120,lastline=120]{new}{ex11}{matrices/Server}
  \inputjava[firstline=121,lastline=126]{old}{ex11}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 11: Utilizando o Serviço de Transformações}
  \inputjava[firstline=55,lastline=55]{old}{ex11}{matrices/Server}
  \inputjava[firstline=56,lastline=63]{new}{ex11}{matrices/Server}
  \inputjava[firstline=64,lastline=66]{old}{ex11}{matrices/Server}
  \inputjava[firstline=67,lastline=76]{new}{ex11}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 11: Autenticando Usando Contexto Salvo}
  \inputjava[firstline=23,lastline=24]{old}{ex11}{matrices/Server}
  \inputjava[firstline=25,lastline=30]{new}{ex11}{matrices/Server}
  \inputjava[firstline=31,lastline=32]{old}{ex11}{matrices/Server}
  \inputjava[firstline=33,lastline=35]{new}{ex11}{matrices/Server}
  \inputjava[firstline=36,lastline=45]{old}{ex11}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=65,lastline=71]{old}{ex12}{matrices/Server}
  \inputjava[firstline=72,lastline=72]{new}{ex12}{matrices/Server}
  \inputjava[firstline=73,lastline=88]{old}{ex12}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=188,lastline=203]{old}{ex13}{matrices/Server}
  \inputjava[firstline=204,lastline=204]{new}{ex13}{matrices/Server}
  \inputjava[firstline=205,lastline=210]{old}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Observador que Descarta Matrizes}
  \inputjava[firstline=70,lastline=72]{old}{ex13}{matrices/Server}
  \inputjava[firstline=73,lastline=74]{new}{ex13}{matrices/Server}
  \inputjava[firstline=75,lastline=76]{old}{ex13}{matrices/Server}
  \inputjava[firstline=77,lastline=78]{new}{ex13}{matrices/Server}
  \inputjava[firstline=79,lastline=80]{old}{ex13}{matrices/Server}
  \inputjava[firstline=81,lastline=94]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Criando Matriz que Notifica Descarte}
  \inputjava[firstline= 96,lastline=107]{old}{ex13}{matrices/Server}
  \inputjava[firstline=108,lastline=111]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Registrando Matriz para Descarte}
  \inputjava[firstline=112,lastline=113]{new}{ex13}{matrices/Server}
  \inputjava[firstline=114,lastline=114]{old}{ex13}{matrices/Server}
  \inputjava[firstline=115,lastline=130]{new}{ex13}{matrices/Server}
  \inputjava[firstline=131,lastline=133]{old}{ex13}{matrices/Server}
  \inputjava[firstline=134,lastline=134]{new}{ex13}{matrices/Server}
  \inputjava[firstline=135,lastline=136]{old}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Registrando Interesse no Login do Solicitante}
  \inputjava[firstline=129,lastline=130]{new}{ex13}{matrices/Server}
  \inputjava[firstline=131,lastline=133]{old}{ex13}{matrices/Server}
  \inputjava[firstline=134,lastline=134]{new}{ex13}{matrices/Server}
  \inputjava[firstline=135,lastline=137]{old}{ex13}{matrices/Server}
  \inputjava[firstline=138,lastline=153]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Descarte da Matriz}
  \inputjava[firstline=155,lastline=175]{new}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Matriz com Dados para Notificar Descarte}
  \inputjava[firstline=35,lastline=37]{old}{ex13}{matrices/Server}
  \inputjava[firstline=38,lastline=42]{new}{ex13}{matrices/Server}
  \inputjava[firstline=43,lastline=44]{old}{ex13}{matrices/Server}
  \inputjava[firstline=45,lastline=46]{new}{ex13}{matrices/Server}
  \inputjava[firstline=47,lastline=55]{old}{ex13}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 13: Notificação do Descarte pela Matriz}
  \inputjava[firstline=49,lastline=65]{old}{ex13}{matrices/Server}
  \inputjava[firstline=66,lastline=66]{new}{ex13}{matrices/Server}
  \inputjava[firstline=67,lastline=68]{old}{ex13}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=140,lastline=157]{old}{ex15}{matrices/Server}
  \inputjava[firstline=158,lastline=158]{new}{ex15}{matrices/Server}
  \inputjava[firstline=159,lastline=167]{old}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Fábrica com Propriedades de Busca do Serviço}
  \inputjava[firstline=57,lastline=58]{old}{ex15}{matrices/Server}
  \inputjava[firstline=59,lastline=67]{new}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Fábrica com Operação de Acesso ao Serviço}
  \inputjava[firstline=108,lastline=116]{old}{ex15}{matrices/Server}
  \inputjava[firstline=117,lastline=117]{new}{ex15}{matrices/Server}
  \inputjava[firstline=118,lastline=120]{old}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Acesso Protegido ao Serviço}
  \inputjava[firstline=69,lastline=81]{new}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Buscando Novo Serviço Ofertado}
  \inputjava[firstline=83,lastline=96]{new}{ex15}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 15: Realizando Última Tentativa}
  \inputjava[firstline=98,lastline=106]{new}{ex15}{matrices/Server}
\end{frame}
...
\begin{frame}
  ...
  \inputjava[firstline=116,lastline=126]{new}{ex19}{watchoffers/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 19: Observando a Remoção de Ofertas}
  \inputjava[firstline=127,lastline=138]{new}{ex19}{watchoffers/Application}
  \inputjava[firstline=139,lastline=145]{old}{ex19}{watchoffers/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 19: Tratando Notificações de Registro Duplicadas}
  \inputjava[firstline=145,lastline=145]{old}{ex19}{watchoffers/Application}
  \inputjava[firstline=146,lastline=152]{new}{ex19}{watchoffers/Application}
  \inputjava[firstline=153,lastline=154]{old}{ex19}{watchoffers/Application}
  \inputjava[firstline=155,lastline=160]{new}{ex19}{watchoffers/Application}
  \inputjava[firstline=161,lastline=161]{old}{ex19}{watchoffers/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 19: Inscrevendo o Observador da Oferta}
  \inputjava[firstline=154,lastline=154]{old}{ex19}{watchoffers/Application}
  \inputjava[firstline=155,lastline=160]{new}{ex19}{watchoffers/Application}
  \inputjava[firstline=161,lastline=161]{old}{ex19}{watchoffers/Application}
  \inputjava[firstline=162,lastline=176]{new}{ex19}{watchoffers/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 19: Tratando Falhas da Inscrição do Observador da Oferta}
  \inputjava[firstline=177,lastline=189]{new}{ex19}{watchoffers/Application}
  \inputjava[firstline=190,lastline=198]{old}{ex19}{watchoffers/Application}
\end{frame}
...
return new Assistant(busHost, busPort, params) {
...
\begin{frame}
  ...
  \inputjava[firstline=62,lastline=63]{old}{ex21}{matrices/Server}
  \inputjava[firstline=64,lastline=64]{new}{ex21}{matrices/Server}
  \inputjava[firstline=65,lastline=72]{old}{ex21}{matrices/Server}
  \inputjava[firstline=73,lastline=73]{new}{ex21}{matrices/Server}
  \inputjava[firstline=74,lastline=74]{old}{ex21}{matrices/Server}
  \inputjava[firstline=75,lastline=75]{new}{ex21}{matrices/Server}
  \inputjava[firstline=76,lastline=89]{old}{ex21}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 21: Usando Assistente nas Buscas de Ofertas (Servidor)}
  \inputjava[firstline= 85,lastline= 92]{old}{ex21}{matrices/Server}
  \inputjava[firstline= 93,lastline= 93]{new}{ex21}{matrices/Server}
  \inputjava[firstline= 94,lastline=104]{old}{ex21}{matrices/Server}
  \inputjava[firstline=105,lastline=105]{new}{ex21}{matrices/Server}
  \inputjava[firstline=106,lastline=108]{old}{ex21}{matrices/Server}
\end{frame}

\begin{frame}
  \frametitle{Exercício 21: Criando o Assistente com Senha (Aplicação)}
  \inputjava[firstline=23,lastline=30]{new}{ex21}{matrices/Application}
  \inputjava[firstline=31,lastline=34]{old}{ex21}{matrices/Application}
  \inputjava[firstline=35,lastline=35]{new}{ex21}{matrices/Application}
  \inputjava[firstline=36,lastline=39]{old}{ex21}{matrices/Application}
  \inputjava[firstline=40,lastline=40]{new}{ex21}{matrices/Application}
  \inputjava[firstline=41,lastline=50]{old}{ex21}{matrices/Application}
\end{frame}

\begin{frame}
  \frametitle{Exercício 21: Encerrando o Assistente ao Final (Aplicação)}
  \inputjava[firstline=51,lastline=68]{old}{ex21}{matrices/Application}
  \inputjava[firstline=69,lastline=72]{new}{ex21}{matrices/Application}
  \inputjava[firstline=73,lastline=74]{old}{ex21}{matrices/Application}
\end{frame}
